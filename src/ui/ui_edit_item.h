...
public:
    ...
    void setupUi(QDialog *dlgEdit)
    {
        ...
        formLayout->setWidget(3, QFormLayout::FieldRole, spnQuantity);
        ...
        formLayout->setWidget(4, QFormLayout::FieldRole, spnBuyingPrice);
        ...
        formLayout->setWidget(5, QFormLayout::FieldRole, spnSellingPrice);
        ...
        formLayout->setWidget(6, QFormLayout::FieldRole, spnMinimumSellingPrice);

        verticalSpacer = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        formLayout->setItem(9, QFormLayout::SpanningRole, verticalSpacer);

        txtCapacity = new QLineEdit(formGroupBox);
        txtCapacity->setObjectName(QString::fromUtf8("txtCapacity"));

        formLayout->setWidget(2, QFormLayout::FieldRole, txtCapacity);
    ...
    void retranslateUi(QDialog *dlgEdit)
    {
        ...
        txtCapacity->setPlaceholderText(QCoreApplication::translate("dlgEdit", "e.g. 500ml, 20g..", nullptr));
